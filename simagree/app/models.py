...
class Identifiants(models.Model):
  ...
  a_imprimer = models.BooleanField(null=True)
  apparition = models.TextField(blank=True, null=True)
  notes = models.TextField(blank=True, null=True)
  ecologie = models.TextField(blank=True, null=True)
  theme1 = models.ForeignKey(Themes, on_delete=models.SET_NULL,
                             null=True, to_field='theme', related_name='Theme1')
  theme2 = models.ForeignKey(Themes, on_delete=models.SET_NULL,
                             null=True, to_field='theme', related_name='Theme2')
  theme3 = models.ForeignKey(Themes, on_delete=models.SET_NULL,
                             null=True, to_field='theme', related_name='Theme3')
  theme4 = models.ForeignKey(Themes, on_delete=models.SET_NULL,
                             null=True, to_field='theme', related_name='Theme4')
...
class Nomenclature(models.Model):
  taxon = models.ForeignKey(
      Identifiants, on_delete=models.CASCADE, to_field='taxon')
...
class ListeRecolte(models.Model):
  ...
  lieu = models.ForeignKey(
      LieuRecolte, on_delete=models.SET_NULL, null=True, blank=True)
